                    ...
                    <tbody>
                        <?php foreach ($list_gift as $value): ?>
                            <tr>
                                ...
                                <td><a href="<?php echo site_url('admincp/orderdetails/'.$value->id);?>">
                                    <?php if($value->order_num == 0):?>
                                        Chưa xác định
                                    <?php endif;?>
                                    <?php if($value->order_num == 1):?>
                                        Đang lựa chọn
                                    <?php endif;?>
                                    <?php if($value->order_num == 2):?>
                                ...
                                <td>
                                     <a data-toggle="modal" role="button" href="<?php echo site_url('admincp/orderdetails/'.$value->id); ?>">
